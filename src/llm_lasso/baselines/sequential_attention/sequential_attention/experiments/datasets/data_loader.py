...
def load_gene_cancer_data_from_split(
    x_train_path="data/train_test_splits/Bank/x_train0.csv",
    x_test_path="data/train_test_splits/Bank/x_test0.csv",
    y_train_path="data/train_test_splits/Bank/y_train0.csv",
    y_test_path="data/train_test_splits/Bank/y_test0.csv"
):
    """
    Loads gene expression data using predefined train/test CSV splits.
    ...
    Args:
        ...
        y_test_path (str): Path to testing labels CSV.

    Returns:
        tuple: (x_train, x_test, y_train, y_test, is_classification, num_classes)
    """
    # Load CSVs
    ...
    # Normalize train and test using training stats only
    scaler = MinMaxScaler()
