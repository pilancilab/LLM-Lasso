"""
Pulls down entire OMIM data via HTTP request with switching APIs and checkpoints for incremental saving.
"""
...
if __name__ == "__main__":
    output_json = "omim_scrape/omim_all/valid_mim_numbers.json"
    process_mim_numbers_to_json("omim_scrape/omim_all/valid_mim_numbers.pkl", output_json, description=True)
